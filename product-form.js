...
Line 84:12 Transforming const to the configured target environment ("es5") is not supported yet
Line 111:24 Transforming object literal extensions to the configured target environment ("es5") is not supported yet
Line 111:38 Transforming default arguments to the configured target environment ("es5") is not supported yet
